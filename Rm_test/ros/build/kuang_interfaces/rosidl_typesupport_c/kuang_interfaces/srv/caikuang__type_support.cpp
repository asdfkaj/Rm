...
static const _Caikuang_Request_type_support_symbol_names_t _Caikuang_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kuang_interfaces, srv, Caikuang_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kuang_interfaces, srv, Caikuang_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, kuang_interfaces, srv, Caikuang_Request)() {
  return &::kuang_interfaces::srv::rosidl_typesupport_c::Caikuang_Request_message_type_support_handle;
}
...
static const _Caikuang_Response_type_support_symbol_names_t _Caikuang_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kuang_interfaces, srv, Caikuang_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kuang_interfaces, srv, Caikuang_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, kuang_interfaces, srv, Caikuang_Response)() {
  return &::kuang_interfaces::srv::rosidl_typesupport_c::Caikuang_Response_message_type_support_handle;
}
...
static const _Caikuang_type_support_symbol_names_t _Caikuang_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kuang_interfaces, srv, Caikuang)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kuang_interfaces, srv, Caikuang)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, kuang_interfaces, srv, Caikuang)() {
  return &::kuang_interfaces::srv::rosidl_typesupport_c::Caikuang_service_type_support_handle;
}
