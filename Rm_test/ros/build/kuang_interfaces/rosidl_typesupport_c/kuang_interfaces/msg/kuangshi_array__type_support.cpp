...
static const _KuangshiArray_type_support_symbol_names_t _KuangshiArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kuang_interfaces, msg, KuangshiArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kuang_interfaces, msg, KuangshiArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, kuang_interfaces, msg, KuangshiArray)() {
  return &::kuang_interfaces::msg::rosidl_typesupport_c::KuangshiArray_message_type_support_handle;
}
